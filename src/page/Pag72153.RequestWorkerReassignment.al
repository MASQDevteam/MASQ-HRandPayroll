page 72153 "Request Worker Reassignment"
{
    ApplicationArea = All;
    Caption = 'Request Worker Reassignment';
    PageType = List;
    SourceTable = "HR Request";
    SourceTableView = where("Request Type" = filter(WorkerReassignment));
    UsageCategory = Lists;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the From Department field.', Comment = '%';
                }
                field("To Department"; Rec."To Department")
                {
                    ToolTip = 'Specifies the value of the To Department field.', Comment = '%';
                }
    ...
    var
        myInt: Integer;
    begin
        Rec."Request Type" := Rec."Request Type"::WorkerReassignment;
    end;
}
